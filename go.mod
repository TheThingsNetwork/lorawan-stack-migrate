...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/iotwireless v1.53.5
...
replace github.com/TheThingsNetwork/ttn/core/types => github.com/TheThingsNetwork/ttn/core/types v0.0.0-20190516112328-fcd38e2b9dc6

replace github.com/chirpstack/chirpstack/api/go/v4 => github.com/chirpstack/chirpstack/api/go/v4 v4.11.1

replace github.com/TheThingsNetwork/api => github.com/TheThingsNetwork/api v0.0.0-20190516111443-a3523f89e84f

replace github.com/TheThingsNetwork/ttn/api => github.com/TheThingsNetwork/ttn/api v0.0.0-20190516081709-034d40b328bd

replace github.com/TheThingsNetwork/ttn/utils/errors => github.com/TheThingsNetwork/ttn/utils/errors v0.0.0-20190516081709-034d40b328bd

replace github.com/brocaar/lorawan => github.com/brocaar/lorawan v0.0.0-20170626123636-a64aca28516d

replace go.thethings.network/lorawan-stack/v3 => go.thethings.network/lorawan-stack/v3 v3.34.0
